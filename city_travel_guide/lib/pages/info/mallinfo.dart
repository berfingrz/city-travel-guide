...
class MallInfo extends StatefulWidget {
  ...
  MallInfo({Key key, this.places}) : super(key: key);
  @override
  _MallInfo createState() => _MallInfo(places: this.places);
}

class _MallInfo extends State<MallInfo> {
  Mall places;
  _MallInfo({this.places});
  ...
  LatLng _center = LatLng(36.5435514720979, 32.0325285814465);
                            ...
                            child: Column(
                              ...
                              children: [
                                ListTile(
                                  ...
                                  title: Text("${places.mallLocation}"),
                                  dense: true,
                                ),
                                ListTile(
                                  leading: Icon(Icons.store_outlined),
                                  title: Text("${places.storeNumber}"),
                                  dense: true,
                                ),
                                ListTile(
