...
class PoliceInfo extends StatefulWidget {
  ...
  PoliceInfo({Key key, this.places}) : super(key: key);
  @override
  _PoliceInfo createState() => _PoliceInfo(places: this.places);
}

class _PoliceInfo extends State<PoliceInfo> {
  Police places;
  _PoliceInfo({this.places});
  ...
  LatLng _center = LatLng(36.5352051496222, 31.9974071163954);
                            ...
                            child: Column(
                              ...
                              children: [
                                ListTile(
                                  ...
                                  title: Text("${places.stationLocation}"),
                                  dense: true,
                                ),
                                ListTile(
